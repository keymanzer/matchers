...
public class CommunityBoardCommentController {
	...
	public String insertComment(@ModelAttribute CommunityBoardComment comment, Principal principal) {
		...
		return "redirect:/user/community/" + comment.getPostId() + "/detail";
	}

	@PostMapping("/{commentId}/update")
	public String updateComment(@PathVariable("commentId") Long commentId,
			@ModelAttribute CommunityBoardComment updatedComment, Principal principal) {
		...
		return "redirect:/user/community/" + updatedComment.getPostId() + "/detail";
	}
	...
	public String deleteComment(@PathVariable("commentId") Long commentId, @RequestParam("postId") Long postId,
		...
		return "redirect:/user/community/" + postId + "/detail";
	}
